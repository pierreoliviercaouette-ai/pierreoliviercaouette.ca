...
export const JemceeLanding = () => {
  useSeoMeta({
    ...
    description:
      'Accueilli depuis le reportage Jemcee sur Jacob Moreau : parallele piste et securite financiere, puis mini-diagnostic de 15-20 minutes avec Pierre-Olivier Caouette.',
      ...
      >
        ...
        <div className="container-max relative z-10 flex flex-col justify-center px-4 md:px-8 py-20 md:py-24 min-h-[72vh] md:min-h-[82vh] text-center">
          ...
          <p className="jemcee-fade-up-delay text-white/85 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            ...
            à Victoriaville — fier de commanditer{' '}
      ...
      <section className="section-padding bg-white relative overflow-hidden">
        ...
        <div className="container-max relative max-w-4xl mx-auto text-center space-y-4 mb-14">
          ...
          <p className="text-prestige-taupe text-lg leading-relaxed max-w-2xl mx-auto">
            En course automobile comme en finances, la performance ne s’improvise pas.
            Discipline, données et décisions prises au bon moment font toute la différence.
          </p>
        </div>
      ...
      <section className="section-padding bg-[linear-gradient(180deg,#f4f6f8_0%,#fff_100%)] relative overflow-hidden">
        <div className="container-max relative max-w-4xl mx-auto">
          <div className="grid lg:grid-cols-[1fr_1.05fr] gap-12 lg:gap-16 items-start">
            ...
            <div className="relative space-y-6 lg:pt-2 rounded-2xl bg-dark text-white p-7 md:p-8 overflow-hidden">
              <div
              ...
              <h3 className="relative font-heading text-2xl font-bold">
                Pourquoi je commandite Jacob Moreau
              </h3>
        ...
        <div className="container-max">
          <div className="relative overflow-hidden rounded-3xl">
            ...
            <div className="relative px-6 py-14 md:px-12 md:py-16 text-center space-y-6">
              <div className="inline-flex items-center gap-2 mx-auto px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full border border-white/20 text-white/90 text-sm font-mono tracking-wide">
